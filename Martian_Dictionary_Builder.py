...
def write():
    ...
    #define fieldnames
        fieldnames = ['Numbers', 'Words', 'Definitions', 'Citations']
    #define writer
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    #Write
        writer.writerow({'Numbers':Numbers, 'Words':Words, 'Definitions':Definitions, 'Citations':Citations})
...
b2.grid( row = 6, column = 1, columnspan = 2)
